...
namespace CDeTDS.DAL
{
    ...
    public class FvuUtilityRunner
    {
        ...
        private const string RunFvuClassB64 =
            "yv66vgAAADQAMgoAAgADBwAEDAAFAAYBABBqYXZhL2xhbmcvT2JqZWN0AQAGPGluaXQ+AQADKClWBwAI" +
            "AQAPY29tL3Rpbi90ZHMvYy9uCAAKAQACcmMKAAwADQcADgwADwAQAQAPamF2YS9sYW5nL0NsYXNzAQAQ" +
            "Z2V0RGVjbGFyZWRGaWVsZAEALShMamF2YS9sYW5nL1N0cmluZzspTGphdmEvbGFuZy9yZWZsZWN0L0Zp" +
            "ZWxkOwoAEgATBwAUDAAVABYBABdqYXZhL2xhbmcvcmVmbGVjdC9GaWVsZAEADXNldEFjY2Vzc2libGUB" +
            "AAQoWilWCgASABgMABkAGgEAA3NldAEAJyhMamF2YS9sYW5nL09iamVjdDtMamF2YS9sYW5nL09iamVj" +
            "dDspVgoAHAAdBwAeDAAfACABAA9jb20vdGluL0ZWVS9GVlUBAARtYWluAQAWKFtMamF2YS9sYW5nL1N0" +
            "cmluZzspVgcAIgEAE2phdmEvbGFuZy9UaHJvd2FibGUKACEAJAwAJQAGAQAPcHJpbnRTdGFja1RyYWNl" +
            "BwAnAQAaamF2YS9sYW5nL1J1bnRpbWVFeGNlcHRpb24KACYAKQwABQAqAQAYKExqYXZhL2xhbmcvVGhy" +
            "b3dhYmxlOylWBwAsAQAGUnVuRlZVAQAEQ29kZQEAD0xpbmVOdW1iZXJUYWJsZQEADVN0YWNrTWFwVGFi" +
            "bGUBAApTb3VyY2VGaWxlAQALUnVuRlZVLmphdmEAIQArAAIAAAAAAAIAAQAFAAYAAQAtAAAAHQABAAEA" +
            "AAAFKrcAAbEAAAABAC4AAAAGAAEAAAAFAAkAHwAgAAEALQAAAHkABAACAAAALBIHEgm2AAtMKwS2ABEr" +
            "ASoQBjK2ABcquAAbpwARTCu2ACO7ACZZK7cAKL+xAAEAAAAaAB0AIQACAC4AAAAmAAkAAAAIAAgACQAN" +
            "AAoAFgALABoADwAdAAwAHgANACIADgArABAALwAAAAcAAl0HACENAAEAMAAAAAIAMQ==";
...
<div style='padding:4px 12px 8px 12px;display:flex;justify-content:flex-end;gap:20px;font-size:9px;color:#555;border-top:1px solid #eee'>
  ...
  <div>Generated by CDeTDS v{CDeTDS.Common.AppConstants.AppVersion} &nbsp;·&nbsp; {DateTime.Now:dd-MMM-yyyy HH:mm}</div>
</div>
...
<div class='hdr'>
  ...
  <p>{H(inputFile)} &nbsp;|&nbsp; {DateTime.Now:dd-MMM-yyyy HH:mm:ss} &nbsp;|&nbsp; CDeTDS v{CDeTDS.Common.AppConstants.AppVersion}</p>
</div>
<div class='summary'>
...
<div class='err-body'><div class='log'>{H(logContent)}</div></div></div>");
                ...
                sb.Append($@"<div class='footer'>CDeTDS v{CDeTDS.Common.AppConstants.AppVersion} &nbsp;|&nbsp; This report was automatically generated when FVU validation failed.</div>
</div></body></html>");
        ...
        private static readonly Dictionary<string, string> _fvuFixHints = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["T-FV-2010"] = "Go to TRACES → Statements / Payments → Oltas Challan Status and verify BSR code, deposit date and serial number. Download fresh CSI file after verifying. Update the challan in CDeTDS to match exactly.",
            ...
            ["T-FV-6004"] = "Delete the generated .txt file and regenerate from the Returns page. If it still fails, contact CDeTDS support.",
        ...
        private static string ResolveJava(string? configuredPath)
        {
            ...
            try
            {
                using var key = Microsoft.Win32.Registry.CurrentUser.OpenSubKey(@"Software\CDeTDS");
