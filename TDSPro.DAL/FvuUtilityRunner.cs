...
<div style='padding:4px 12px 8px 12px;display:flex;justify-content:flex-end;gap:20px;font-size:9px;color:#555;border-top:1px solid #eee'>
  ...
  <div>Generated by CDeTDS v{TDSPro.Common.AppConstants.AppVersion} &nbsp;·&nbsp; {DateTime.Now:dd-MMM-yyyy HH:mm}</div>
</div>
...
<div class='hdr'>
  ...
  <p>{H(inputFile)} &nbsp;|&nbsp; {DateTime.Now:dd-MMM-yyyy HH:mm:ss} &nbsp;|&nbsp; CDeTDS v{TDSPro.Common.AppConstants.AppVersion}</p>
</div>
<div class='summary'>
...
<div class='err-body'><div class='log'>{H(logContent)}</div></div></div>");
                ...
                sb.Append($@"<div class='footer'>CDeTDS v{TDSPro.Common.AppConstants.AppVersion} &nbsp;|&nbsp; This report was automatically generated when FVU validation failed.</div>
</div></body></html>");
