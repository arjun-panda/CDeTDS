...
<div class=""page-header"">
  ...
  <div class=""watermark"">Generated by TDS Pro v{TDSPro.Common.AppConstants.AppVersion} · {now} · FOR REFERENCE ONLY — Submit .fvu file to TRACES portal</div>
</div>
...
<div class=""info-grid"">
  ...
  <div class=""info-cell""><span class=""info-label"">Deductor Type</span><span class=""info-value"">{Esc(h.DeductorType)} {(!string.IsNullOrEmpty(h.DeductorType) ? $"(Code: {TDSPro.DAL.FvuGenerator.GetDeductorCategoryPublic(h.DeductorType)})" : "")}</span></div>
...
<thead><tr>
  ...
  <td></td>
            ...
            string annexureSigLabel = h.FormType == "24Q"
...
<div class=""sign-block"">
  ...
  <div style=""flex:1;border-left:1px solid #ccc;padding-left:16px;font-size:8.5pt;color:#555"">
    ...
    Form No. {h.FormType}<br/>
    Quarter: {h.Quarter} &nbsp;·&nbsp; FY: {h.FinancialYear}<br/>
...
<div class=""footer"">
  ...
  {(h.FormType=="24Q" ? "(4) Salary includes wages, annuity, pension, gratuity, fees, commission, bonus, perquisites, profits in lieu of or in addition to any salary or wages. (5) Please record on every page the totals of each of the columns." : "(4) Note: Write 'A' if lower deduction or 'B' if no deduction is on account of a certificate under section 197.")}<br/>
  <span style=""color:#aaa"">Computer-generated paper copy &nbsp;·&nbsp; TDS Pro v{TDSPro.Common.AppConstants.AppVersion} &nbsp;·&nbsp; {now} &nbsp;·&nbsp; Submit the validated .fvu file to TRACES portal — this printout is for record only.</span>
</div>
