...
<div class='ed-wrap'>
  ...
  <div>
    ...
    <div>Generated by CDeTDS v{TDSPro.Common.AppConstants.AppVersion} &nbsp;|&nbsp; {TDSPro.Common.TaxRules.ActName(entry.FinancialYear)} &nbsp;|&nbsp; {DateTime.Now:dd-MMM-yyyy HH:mm}</div>
  </div>
  <div class='sig-block'>
    ...
    <div>Authorised Signatory</div>
            ...
            string             outputFolder)
        {
            ...
            // ── Footer ───────────────────────────────────────────────────────
            ws.Range(r,1,r,4).Merge();
            ws.Cell(r,1).Value = $"Computer generated — CDeTDS v{TDSPro.Common.AppConstants.AppVersion}  |  {TDSPro.Common.TaxRules.ActName(entry.FinancialYear)}  |  {DateTime.Now:dd-MMM-yyyy HH:mm}";
...
<div class='hdr' style='margin-top:0;padding-top:8px'>
  <div>
    ...
    <div style='font-size:8.5px;color:#6b7280;margin-top:2px'>CDeTDS v{TDSPro.Common.AppConstants.AppVersion} &nbsp;|&nbsp; {TDSPro.Common.TaxRules.ActName(fy)}</div>
  </div>
...
<div class='footer'>Computer-generated &nbsp;|&nbsp; CDeTDS v{TDSPro.Common.AppConstants.AppVersion} &nbsp;|&nbsp; Not a legal document &nbsp;|&nbsp; {TDSPro.Common.TaxRules.ActName(fy)}</div>
</div></body></html>");
...
<tr>");
            ...
            sb2.Append($"<div class='footer'>Computer-generated &nbsp;|&nbsp; CDeTDS &nbsp;|&nbsp; {DateTime.Now:dd-MMM-yyyy HH:mm} &nbsp;|&nbsp; Not a legal document</div>");
            ...
            EmployeeYearSummary? yearSummary = null)
        {
            ...
            // Footer
            ws.Range(r,1,r,3).Merge();
            ws.Cell(r,1).Value = $"Generated by CDeTDS v{TDSPro.Common.AppConstants.AppVersion} | Income-tax Act 2025 | {DateTime.Now:dd-MMM-yyyy}";
            ws.Cell(r,1).Style.Font.Italic = true;
