...
namespace CDeTDS.DAL
{
    ...
    public static class SalarySlipExport
    {
            ...
            string             outputFolder)
        {
            ...
            allDeductions.Add(($"Income Tax ({CDeTDS.Common.TaxRules.SalaryTdsSection(entry.FinancialYear)})", entry.TdsDeducted));
  ...
  <div class='sig-block'>
    ...
    <div>Authorised Signatory</div>
            ...
            string             outputFolder)
        {
            ...
            dedsList.Add(($"Income Tax ({CDeTDS.Common.TaxRules.SalaryTdsSection(entry.FinancialYear)})", entry.TdsDeducted));
...
<tr>");
            ...
            EmployeeYearSummary? yearSummary = null)
        {
            ...
            // Footer
            ws.Range(r,1,r,3).Merge();
            ws.Cell(r,1).Value = $"Generated by CDeTDS v{CDeTDS.Common.AppConstants.AppVersion} | Income-tax Act 2025 | {DateTime.Now:dd-MMM-yyyy}";
            ws.Cell(r,1).Style.Font.Italic = true;
