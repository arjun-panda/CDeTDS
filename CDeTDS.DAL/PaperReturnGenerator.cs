...
{(newAct && isSalaryForm
    // ── Official Form 138 PART A: 16-row numbered table (Gazette layout) ──
    ? $@"<table class=""partA"">
...
");
            ...
            bool officialPartB = newAct && isSalaryForm;   // Form 138 official A–K layout
            if (officialPartB)
            {
...
<thead><tr>
  ...
  <span>Total TDS: ₹{gTotal:N0}</span>
            ...
            else
            {
                ...
                sb.Append(@"<div class=""section-title"">ANNEXURE I — DEDUCTEE DETAILS (per Challan)</div>");
