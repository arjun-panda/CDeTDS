...
@media print{body{background:#fff}.page{box-shadow:none;margin:0;padding:10mm}}
        ...
        internal void AddTitlePage(string title, string subtitle)
        {
            ...
            _html.Append($"<div class='meta'>Generated by CDeTDS &nbsp;|&nbsp; {_createdAt} &nbsp;|&nbsp; {CDeTDS.Common.TaxRules.ActName(CDeTDS.Common.AppConstants.CurrentFinancialYear)}</div>");
        }
        ...
        {
            _html.Append($"<div class='footer'>CDeTDS v{CDeTDS.Common.AppConstants.AppVersion} &nbsp;|&nbsp; {CDeTDS.Common.TaxRules.ActName(CDeTDS.Common.AppConstants.CurrentFinancialYear)} &nbsp;|&nbsp; Printed: {_createdAt}</div>");
