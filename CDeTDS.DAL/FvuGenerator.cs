...
namespace CDeTDS.DAL
{
    ...
    public static class FvuGenerator
    {
        ...
        private static string BuildSD(ReturnSalaryDetail sd, int seq, string lineNo, string challanSlNo, string fy)
        {
            ...
            // NSDL TaxRegime code: "O" = new regime (115BAC=Y, ₹75K std ded FY 2025-26); "N" = old regime (₹50K).
            ...
            // Bills reimbursements (conveyance, telephone u/s 10(14)(i)) are NOT reported as Sec10
            // exemptions in SD — they reduce the gross pay before salary entry, so they are already
            // reflected in the lower tax figures. SD[16] and SD[22] show pre-exemption salary figures.
        ...
        {
            string F(double v) => v.ToString("F2");
            // NSDL code "O" = new regime (₹75K FY 2025-26); "N" = old regime (₹50K)
        ...
        public static string GetSampleStructure(string formType = "26Q")
        {
            ...
            sb.AppendLine($"// Generated by CDeTDS | Format: Protean RPU 5.6+ / FVU 9.4 | Delimiter: ^");
            sb.AppendLine();
