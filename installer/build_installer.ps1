# TDS Pro — Installer Build Script
...
Write-Host "=== TDS Pro Installer Build ===" -ForegroundColor Cyan
...
$exe = Get-ChildItem "$PSScriptRoot\Output\TDSPro_Setup_v*.exe" | Select-Object -Last 1
